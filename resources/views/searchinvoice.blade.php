		    ...
		    <div class="card-body">
		    	...
		    	<p id="texts">Enter The Bilti Number To Search Detail</p><br>
		    	  <div class="form-group">
		    	  	<form action="/searchinvoicebybilti" method="post">
		    	  		@csrf
	    ...
	    <div class="card text-black  mb-3" id="cards3" >
		    <div class="card-body">
		    	<p class="text-center" id="para">Search Invoice By Date</p>
		    	  ...
		    	  <div class="form-group">
		    	  	<form action="/searchinvoicebydate" method="GET">
		    	  		@csrf
	...
	<div class="col-lg-6 mt-5">
	    <div class="card text-black  mb-3" id="cards4">
		    <div class="card-body">
		    	...
		    	<div class="form-group">
		    		<form action="/searchinvoicebyconsignor" method="GET">
		    			@csrf
                 <input type="name" class="form-control" name="consignor" placeholder="Enter The Consignor Name" required/>
                 <br>
...
<div class="col-lg-6 mt-5">
	    <div class="card text-black  mb-3" id="cards5">
		    <div class="card-body">
		    	...
		    	<div class="form-group">
		    		<form action="/searchinvoicebyconsignee" method="GET">
		    			@csrf
                 <input type="name" class="form-control" name="consignee" placeholder="Enter The Consignee Name" required/>
                 <br>
