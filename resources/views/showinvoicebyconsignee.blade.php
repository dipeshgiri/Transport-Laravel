...
<div class="col-sm-9 col-md-10" style="background-color: white;">
   ...
   @endforeach
      ...
      <p id="page">Total Invoice: {{$data->total()}}</p>
      <br>
      <br>
      {{$data->appends(['date' => $datas->date])->render()}}
      <a href="/allinvoicepdfbyconsignee/{{$datas->consignee}}" class="btn btn-primary">Export As PDF</a>
