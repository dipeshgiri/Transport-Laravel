...
<head>
	...
	<title>Invoice Data By Consignor Name</title>
</head>
<body>
   ...
   <p><label class="consignor">Consignor Name: </label>{{$consignor}}<label class="address2">Address: </label>{{$address}}<label class="pan">Pan No:</label>{{$pan}}</p>
         <table>
         	<thead>
         		<tr>
         			<th >Bilti</th>
